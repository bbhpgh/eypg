...
<head>
    ...
    <title>帐户明细_<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>
    </title>
...
<div class="main-content clearfix">
    ...
    <div class="left">
        ...
        <div class="sidebar-nav">
            ...
            <h3 url="/user/UserBalance.html" haschild="1" class="sid-icon05 "><a href="javascript:;"><b></b>账户管理 <s
                    title="收起"></s></a></h3>
            <ul>
                <li class="sid-cur"><a href="/user/UserBalance.html">账户明细</a></li>
    ...
    <div class="R-content">
        ...
        <div class="last">
            <ul>
                <li><h3>您的账户可用余额为：</h3><b class="orange">${user.balance }</b>元 <a title="充值" class="bluebut"
...
<script language="javascript" type="text/javascript"
        src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/userbalance.js?data=20131121"></script>
<script type="text/javascript"
