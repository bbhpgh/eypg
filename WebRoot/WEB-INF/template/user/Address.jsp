...
<head>
    ...
    <title>收货地址_<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>
    </title>
...
<script language="javascript" type="text/javascript"
        src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/address.js?data=20131121"></script>
<script language="javascript" type="text/javascript"
