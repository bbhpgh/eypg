...
<div class="main-content clearfix">
    ...
    <div class="R-content">
        ...
        <div class="get-pro gray02">您总共成功<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>获得商品 <b
                class="orange" id="goodsCount">${resultCount }</b> 个
        </div>
...
<script language="javascript" type="text/javascript"
        src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/orderlist.js?data=20131121"></script>
<script language="javascript" type="text/javascript"
