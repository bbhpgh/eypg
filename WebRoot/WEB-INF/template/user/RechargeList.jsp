...
<head>
    ...
    <title>充值记录_1元<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>
    </title>
    ...
    <div class="location">
        <p>
            您的现在的位置：<a href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>">首页</a> &gt; <a
                href="/user/index.html">我的1元<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>
        </a> &gt; 充值记录</p>
    </div>
            ...
            <div class="member_right_main">
                ...
                <div class="consumer_records">
                    ...
                    <div id="RecordList" class="consumer_records_list">
                        <ul class="gtitle">
                            <li class="time">充值时间</li>
                            <li class="much">资金渠道</li>
                            <li class="status">充值金额</li>
                        </ul>
...
<script language="javascript" type="text/javascript"
        src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/rechargelist.js"></script>
</body>
</html>
