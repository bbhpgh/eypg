...
<head>
    ...
    <title>修改密码_<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>
    </title>
...
<script language="javascript" type="text/javascript"
        src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/updatepassword.js?data=20131121"></script>
<script language="javascript" type="text/javascript"
