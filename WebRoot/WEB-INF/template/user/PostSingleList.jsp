...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/css/layoutsingle.css?data=20131121"/>
    <link rel="stylesheet" type="text/css"
...
<div class="main-content clearfix">
    ...
    <div class="R-content">
        ...
        <div class="single-titR">成功晒单并通过审核立即获得10元</div>
...
<script language="javascript" type="text/javascript"
        src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/postsinglelist.js?data=20131121"></script>
</body>
</html>
