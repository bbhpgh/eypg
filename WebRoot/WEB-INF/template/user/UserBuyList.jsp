...
<head>
    ...
    <title>我参与的<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>
        _<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>
    </title>
    <link rel="stylesheet" type="text/css"
          href="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/css/layoutframe.css?data=20131121"/>
    <link rel="stylesheet" type="text/css"
          href="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/css/layoutrecords.css?data=20131121"/>
    <link rel="stylesheet" type="text/css"
...
<script language="javascript" type="text/javascript"
        src="<%=ApplicationListenerImpl.sysConfigureJson.getSkinUrl()%>/js/userbuylist.js?data=20131121"></script>
<script language="javascript" type="text/javascript"
