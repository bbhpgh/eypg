            ...
            <div class="Pro_Detright">
                ...
                <div class="Announced_Frame" id="divLotteryTimer">
                    ...
                    <div class="Announced_FrameCode">
                        <div class="Announced_FrameClock">
                            <img border="0" alt=""
                                 src="<%=ApplicationListenerImpl.sysConfigureJson.getImgUrl()%>/Images/Announced_Clock.gif"/>
                        </div>
                    ...
                    <div class="Announced_FrameGet">
                        <p class="Announced_FrameLanguage">
                            <img border="0" alt=""
                                 src="<%=ApplicationListenerImpl.sysConfigureJson.getImgUrl()%>/Images/1.gif"
                                 id="imgFunny"/>
                        </p>
                    </div>
                ...
                <div style="display: none;" class="Announced_Frame" id="divLotteryTiming">
                    ...
                    <div class="Announced_FrameCal">
                        <p><img border="0" alt=""
                                src="<%=ApplicationListenerImpl.sysConfigureJson.getImgUrl()%>/Images/Announced_6.png"/>
                        </p>
                        <span><img border="0" alt=""
                                   src="<%=ApplicationListenerImpl.sysConfigureJson.getImgUrl()%>/Images/Announced_4.gif"/></span>
                    </div>
                    <div class="Announced_FrameBm"></div>
                </div>
                <div class="Security">
                                    ...
                                    <s:iterator var="ParticipateJSON" value="ParticipateJSONList">
                                        <li><a target="_blank"
                                               ...
                                               rel="nofollow"><img width="20" height="20" border="0" alt=""
                                                                   src="${ParticipateJSON.userFace }"/></a><a
                    ...
                    <div style="display:none;" class="Newest_Con">
                        ...
                        <p class="MsgIntro1"><%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>
                            ...
                            ，惊喜无限”为宗旨，力求打造一个100%公平公正、100%正品保障、寄娱乐与购物一体化的新型购物网站。<a target="_blank" class="blue"
                                                                                  href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/help/index.html">查看详情&gt;&gt;</a>
                        </p>
                    </div>
                </div>
            </div>
