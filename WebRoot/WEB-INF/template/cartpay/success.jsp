                    ...
                    <ul>
                        ...
                        <s:iterator value="successCartList" var="successCart">
                            <li class="wait_Lodity"><span class="wait_Cw01">${successCart.buyDate}</span><span
                                    class="wait_Cw02"><a class="blue" title="${successCart.productName }"
                                                         href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/products/${successCart.productId }.html">${successCart.productName }</a></span><span
                    ...
                    <dl>
                        ...
                        <dd>
                            <h2 class="orange Fb">哎呀！<%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>
                                失败了。</h2>
                            <p>您现在可以 <a class="blue"
                                        href="<%=ApplicationListenerImpl.sysConfigureJson.getWwwUrl()%>/cartPay/index.html">查看购物车</a>
                                或 <a class="blue"
