...
<head>
    ...
    <title>${userName }_晒单_个人主页_<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%> <%=ApplicationListenerImpl.sysConfigureJson.getShortName() %>
        网</title>
...
<div class="layout980 clearfix">
    ...
    <div class="content clearfix">
        ...
        <div class="New-content">
            ...
            <div class="goods_share_list" id="pageListItems">
                <ul>
