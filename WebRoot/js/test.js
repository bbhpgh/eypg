...
$(function () {
    ...
    var z = function () {
        ...
        y.bind("click", function () {
            ...
            var K = function () {
//				alert($www+"/mycart/goPay.html?moneyCount="+k+"&integral="+F+"&userPayType=2");
//				return false;
                location.replace($www + "/mycart/goPay.html?moneyCount=" + k + "&integral=" + F + "&userPayType=2");
            };
            var X = function () {
//				alert($www+"/mycart/goPay.html?moneyCount="+k+"&integral="+F+"&hidUseBalance="+$("#hidUseBalance").val()+"&userPayType=1");
//				return false;
